...
public class GroupTableModel extends DefaultTableModel {
    ...
    private String[] columnNames = {"Index", "Artifact ID", "Group ID", "Usages"};

    private JTable table;

    private List<DependenceGroupItem> data;

    public GroupTableModel(JTable table) {
        this.table = table;
    ...
    private Vector<Object> convertData(DependenceGroupItem groupItem) {
     ...
     * @param list
     */
    public void setupTable(List<DependenceGroupItem> list) {
        this.data = list;
    ...
    private void updateData(DependenceGroupItem groupItem, int index) {
        Vector<Object> convertData = convertData(groupItem);
