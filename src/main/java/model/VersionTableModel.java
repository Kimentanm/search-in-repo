...
public class VersionTableModel extends DefaultTableModel {
    ...
    public VersionTableModel(JBTable table) {
        this.table = table;
    ...
    private Vector<Object> convertData(VersionItem versionItem) {
     ...
     * @param list
     */
    public void setupTable(List<VersionItem> list) {
        this.data = list;
    ...
    private void updateData(VersionItem packageItem, int index) {
    ...
    public List<VersionItem> getData() {
        return data;
    }
